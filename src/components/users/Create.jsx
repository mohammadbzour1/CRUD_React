...
export default function Create() {
  ...
  <div className="row flex-nowrap">
    ...
    <form onSubmit={sentData}>
        <Input errors={errors} id={"username"} type={'text'} name={'name'} changeData={()=>changeData(event)} title={'user name'}/>
        <Input errors={errors} id={"email"} type={'email'} name={'email'} changeData={()=>changeData(event)} title={'user email'}/>
        <Input errors={errors} id={"password"} type={'password'} name={'password'} changeData={()=>changeData(event)} title={'user password'} additionClass={'bg-danger'}/>
